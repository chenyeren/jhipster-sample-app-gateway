...
import com.chenyr.myapp.config.KafkaProperties;
...
class JhipsterSampleAppGatewayKafkaResourceIT {
    ...
    void setup() {
        ...
        JhipsterSampleAppGatewayKafkaResource kafkaResource = new JhipsterSampleAppGatewayKafkaResource(kafkaProperties);
    ...
    void producesMessages() throws Exception {
        restMockMvc
            .perform(post("/api/jhipster-sample-app-gateway-kafka/publish/topic-produce?message=value-produce"))
    ...
    void consumesMessages() throws Exception {
        ...
        MvcResult mvcResult = restMockMvc
            .perform(get("/api/jhipster-sample-app-gateway-kafka/consume?topic=topic-consume"))
            .andExpect(status().isOk())
