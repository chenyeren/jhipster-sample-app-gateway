...
@RestController
@RequestMapping("/api/jhipster-sample-app-gateway-kafka")
public class JhipsterSampleAppGatewayKafkaResource {
    private final Logger log = LoggerFactory.getLogger(JhipsterSampleAppGatewayKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public JhipsterSampleAppGatewayKafkaResource(KafkaProperties kafkaProperties) {
